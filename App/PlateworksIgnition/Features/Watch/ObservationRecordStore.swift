...
final class ObservationRecordStore {
    ...
    private static func defaultDirectory() -> URL? {
        ...
        if ProcessInfo.processInfo.arguments.contains(AppEnvironment.resetStateArgument) {
            let name = "org.plateworks.ignition.uitest.record.\(ProcessInfo.processInfo.processIdentifier)"
        ...
        return ensured(support.appendingPathComponent("PlateworksIgnition", isDirectory: true))
    }
