...
> Field-fast Probability of Ignition from the IRPG — enter temp, RH, and site
...
plain-language fire-behavior interpretation.
...
`wildland,fire,PIG,ignition,fuel moisture,IRPG,fire weather,RH,humidity,firefighter,NWCG,dispatch`

## Category
- Primary: Weather (or Utilities)
- Secondary: Reference
...
- Source data is the public-domain NWCG IRPG (PMS 461) and PMS 437 tables; see
  `ATTRIBUTION.md`.
